...
const SignIn = () => {
  ...
  const { signIn, signInWithOtp, resetPassword } = useWallet();
      ...
      >
        ...
        <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 backdrop-blur-xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Button type="submit" disabled={loading} className="w-full h-12 bg-purple-600 hover:bg-purple-500 font-bold rounded-xl shadow-lg">
              {loading ? <Loader2 className="animate-spin" /> : mode === 'password' ? 'Sign In' : 'Send Magic Link'}
            </Button>
          </form>
