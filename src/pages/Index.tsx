    ...
    <Layout noPadding className="flex flex-col lg:flex-row">
      <div className="flex-1 border-r border-white/5 w-full lg:max-w-3xl">
        ...
        <div className="p-4 md:p-6 border-b border-white/5 grid grid-cols-3 gap-2 md:gap-4">
          <button className="flex flex-col items-center justify-center gap-1.5 p-2 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br from-purple-600/10 to-transparent border border-purple-500/10 hover:border-purple-500/30 transition-all group text-center">
          ...
          <button className="flex flex-col items-center justify-center gap-1.5 p-2 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/10 hover:border-blue-500/30 transition-all group text-center">
          ...
          <button className="flex flex-col items-center justify-center gap-1.5 p-2 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br from-green-600/10 to-transparent border border-green-500/10 hover:border-green-500/30 transition-all group text-center">
